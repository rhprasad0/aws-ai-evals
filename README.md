...
Current phase: **Week 2 in progress: expanded datasets and live-response capture next**. The roadmap is documentation-first, then code/infrastructure, with the `ryanprasad.ai` candidate agent as the live specimen from Week 1.
...
| 2 | 🧱 Dataset contracts and schema validators | Synthetic recruiter Q&A, skill-to-evidence labels, unsupported/private-info, and inert injection cases | 🟨 In progress | 🟩🟩🟩🟩⬜ 80% |
